...
- Опционально: **CocoIndex** (`pipx install 'cocoindex-code[full]'` или `uv tool install 'cocoindex-code[full]'`) — семантический поиск по коду (заменяет grep_search в агентах)
